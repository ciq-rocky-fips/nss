...
cwd=`pwd`
pushd ./lib/softoken/Linux4.18_x86_64_cc_glibc_PTH_64_DBG.OBJ
$cwd/cmd/shlibsign/Linux4.18_x86_64_cc_glibc_PTH_64_DBG.OBJ/shlibsign -v -i libsoftokn3.so
popd
pushd ./lib/freebl/Linux4.18_x86_64_cc_glibc_PTH_64_DBG.OBJ/Linux_SINGLE_SHLIB
$cwd/cmd/shlibsign/Linux4.18_x86_64_cc_glibc_PTH_64_DBG.OBJ/shlibsign -v -i libfreeblpriv3.so
popd
