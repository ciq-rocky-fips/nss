...
export LD_PRELOAD="$PWD/../dist/${build_dir}/lib/libsmime3.so \
$PWD/../dist/${build_dir}/lib/libnsssysinit.so \
$PWD/../dist/${build_dir}/lib/libnssutil3.so \
$PWD/../dist/${build_dir}/lib/libnssdbm3.so \
$PWD/../dist/${build_dir}/lib/libsoftokn3.so \
$PWD/../dist/${build_dir}/lib/libfreeblpriv3.so \
$PWD/../dist/${build_dir}/lib/libfreebl3.so \
$PWD/../dist/${build_dir}/lib/libnssckbi-testlib.so \
$PWD/../dist/${build_dir}/lib/libnssckbi.so \
$PWD/../dist/${build_dir}/lib/libssl3.so \
$PWD/../dist/${build_dir}/lib/libpkcs11testmodule.so"

export PATH=.:$PWD/../dist/${build_dir}/bin:$PWD/../dist/${build_dir}/lib:/bin:/usr/bin:/usr/local/bin:/usr/local/sbin:/usr/sbin
export LD_LIBRARY_PATH=$PWD/../dist/${build_dir}/lib:

export CPU_ARCH="x86_64"
export NSS_DISABLE_AVX2=0
export OBJDIR=${build_dir}
export BINDIR=$PWD/../dist/${build_dir}/bin
